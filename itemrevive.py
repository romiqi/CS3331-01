#Item-Revive program for 2024-CS3331-01 homework
#This program can add items,delete items,find items and list the infomation of all items,with GUI to be more convenient 
#Author:Mingyi Luo
#Student ID:521021911006
...
class AddItems:#添加物品
	...
	def returnToHomePage(self):#返回初始页面的函数
